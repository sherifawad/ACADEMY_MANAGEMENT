...
exports.Prisma.UserPasswordScalarFieldEnum = makeEnum({
  id: 'id',
  password: 'password',
...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/home/eng/repos/academy_management/auth/src/prisma/genrated",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
...
path.join(process.cwd(), "src/prisma/genrated/libquery_engine-debian-openssl-1.1.x.so.node")
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "src/prisma/genrated/schema.prisma")
