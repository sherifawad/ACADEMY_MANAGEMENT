...
/**
   ...
   * `prisma.userPassword`: Exposes CRUD operations for the **UserPassword** model.
    ...
    * ```
    */
  get userPassword(): Prisma.UserPasswordDelegate<GlobalReject>;
...
export namespace Prisma {
  ...
  */
  ...
  export type UserPasswordGroupByArgs = {
    ...
    by: Array<UserPasswordScalarFieldEnum>
  ...
  type GetUserPasswordGroupByPayload<T extends UserPasswordGroupByArgs> = PrismaPromise<
    Array<
  ...
  export type UserPasswordGetPayload<
    S extends boolean | null | undefined | UserPasswordArgs,
    U = keyof S
      > = S extends true
        ? UserPassword
    : S extends undefined
    ? never
    : S extends UserPasswordArgs | UserPasswordFindManyArgs
    ?'include' extends U
    ? UserPassword  & {
    ...
    ? {
    [P in TrueKeys<S['select']>]:
        P extends 'user' ? UserGetPayload<S['select'][P]> :  P extends keyof UserPassword ? UserPassword[P] : never
  } 
    : UserPassword
  : UserPassword


  type UserPasswordCountArgs = Merge<
    Omit<UserPasswordFindManyArgs, 'select' | 'include'> & {
      select?: UserPasswordCountAggregateInputType | true
    }
  >

  export interface UserPasswordDelegate<GlobalRejectSettings> {
    /**
     ...
     * })
    **/
    findUnique<T extends UserPasswordFindUniqueArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args: SelectSubset<T, UserPasswordFindUniqueArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'UserPassword'> extends True ? CheckSelect<T, Prisma__UserPasswordClient<UserPassword>, Prisma__UserPasswordClient<UserPasswordGetPayload<T>>> : CheckSelect<T, Prisma__UserPasswordClient<UserPassword | null >, Prisma__UserPasswordClient<UserPasswordGetPayload<T> | null >>
     ...
     * })
    **/
    findFirst<T extends UserPasswordFindFirstArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args?: SelectSubset<T, UserPasswordFindFirstArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'UserPassword'> extends True ? CheckSelect<T, Prisma__UserPasswordClient<UserPassword>, Prisma__UserPasswordClient<UserPasswordGetPayload<T>>> : CheckSelect<T, Prisma__UserPasswordClient<UserPassword | null >, Prisma__UserPasswordClient<UserPasswordGetPayload<T> | null >>
    ...
    **/
    findMany<T extends UserPasswordFindManyArgs>(
      args?: SelectSubset<T, UserPasswordFindManyArgs>
    ): CheckSelect<T, PrismaPromise<Array<UserPassword>>, PrismaPromise<Array<UserPasswordGetPayload<T>>>>
    ...
    **/
    create<T extends UserPasswordCreateArgs>(
      args: SelectSubset<T, UserPasswordCreateArgs>
    ): CheckSelect<T, Prisma__UserPasswordClient<UserPassword>, Prisma__UserPasswordClient<UserPasswordGetPayload<T>>>
    ...
    **/
    createMany<T extends UserPasswordCreateManyArgs>(
      args?: SelectSubset<T, UserPasswordCreateManyArgs>
    ...
    **/
    delete<T extends UserPasswordDeleteArgs>(
      args: SelectSubset<T, UserPasswordDeleteArgs>
    ): CheckSelect<T, Prisma__UserPasswordClient<UserPassword>, Prisma__UserPasswordClient<UserPasswordGetPayload<T>>>
    ...
    **/
    update<T extends UserPasswordUpdateArgs>(
      args: SelectSubset<T, UserPasswordUpdateArgs>
    ): CheckSelect<T, Prisma__UserPasswordClient<UserPassword>, Prisma__UserPasswordClient<UserPasswordGetPayload<T>>>
    ...
    **/
    deleteMany<T extends UserPasswordDeleteManyArgs>(
      args?: SelectSubset<T, UserPasswordDeleteManyArgs>
    ): PrismaPromise<BatchPayload>
    ...
    **/
    updateMany<T extends UserPasswordUpdateManyArgs>(
      args: SelectSubset<T, UserPasswordUpdateManyArgs>
    ): PrismaPromise<BatchPayload>
    ...
    **/
    upsert<T extends UserPasswordUpsertArgs>(
      args: SelectSubset<T, UserPasswordUpsertArgs>
    ): CheckSelect<T, Prisma__UserPasswordClient<UserPassword>, Prisma__UserPasswordClient<UserPasswordGetPayload<T>>>

    /**
     * Find one UserPassword that matches the filter or throw
    ...
    **/
    findUniqueOrThrow<T extends UserPasswordFindUniqueOrThrowArgs>(
      args?: SelectSubset<T, UserPasswordFindUniqueOrThrowArgs>
    ): CheckSelect<T, Prisma__UserPasswordClient<UserPassword>, Prisma__UserPasswordClient<UserPasswordGetPayload<T>>>
    ...
    **/
    findFirstOrThrow<T extends UserPasswordFindFirstOrThrowArgs>(
      args?: SelectSubset<T, UserPasswordFindFirstOrThrowArgs>
    ): CheckSelect<T, Prisma__UserPasswordClient<UserPassword>, Prisma__UserPasswordClient<UserPasswordGetPayload<T>>>
    ...
    **/
     ...
     * })
    **/
    aggregate<T extends UserPasswordAggregateArgs>(args: Subset<T, UserPasswordAggregateArgs>): PrismaPromise<GetUserPasswordAggregateType<T>>
    ...
    **/
    ...
    >(args: SubsetIntersection<T, UserPasswordGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetUserPasswordGroupByPayload<T> : PrismaPromise<InputErrors>
  }
   ...
   */
  export class Prisma__UserPasswordClient<T> implements PrismaPromise<T> {
    [prisma]: true;
   ...
   */
  export type UserPasswordFindUniqueArgsBase = {
    /**
     * Select specific fields to fetch from the UserPassword
     * 
    **/
    select?: UserPasswordSelect | null
    /**
     * Choose, which related nodes to fetch as well.
     * 
    **/
    include?: UserPasswordInclude | null
    /**
   ...
   */
  export interface UserPasswordFindUniqueArgs extends UserPasswordFindUniqueArgsBase {
   /**
   ...
   */
  export type UserPasswordFindFirstArgsBase = {
    /**
     * Select specific fields to fetch from the UserPassword
     * 
    **/
   ...
   */
  export interface UserPasswordFindFirstArgs extends UserPasswordFindFirstArgsBase {
   /**
    * Throw an Error if query returns no results
   ...
   */
  export type UserPasswordFindUniqueOrThrowArgs = UserPasswordFindUniqueArgsBase
      

  /**
   * UserPassword: findFirstOrThrow
   */
  export type UserPasswordFindFirstOrThrowArgs = UserPasswordFindFirstArgsBase
  ...
  export type UserSelect = {
    ...
    password?: boolean | UserPasswordArgs
  ...
  export type UserGetPayload<
    ...
    [P in TrueKeys<S['include']>]:
        ...
        P extends 'password' ? UserPasswordGetPayload<S['include'][P]> | null :
    ...
    [P in TrueKeys<S['select']>]:
        ...
        P extends 'password' ? UserPasswordGetPayload<S['select'][P]> | null :
  ...
  export class Prisma__UserClient<T> implements PrismaPromise<T> {
    ...
    password<T extends UserPasswordArgs = {}>(args?: Subset<T, UserPasswordArgs>): CheckSelect<T, Prisma__UserPasswordClient<UserPassword | null >, Prisma__UserPasswordClient<UserPasswordGetPayload<T> | null >>;
  ...
  export type UserPasswordWhereInput = {
    ...
    forceChange?: BoolFilter | boolean
  ...
  export type UserPasswordScalarWhereWithAggregatesInput = {
    ...
    forceChange?: BoolWithAggregatesFilter | boolean
  ...
  export type UserWhereInput = {
    ...
    password?: XOR<UserPasswordRelationFilter, UserPasswordWhereInput> | null
  }
  ...
  export type UserPasswordUpdateInput = {
    ...
    forceChange?: BoolFieldUpdateOperationsInput | boolean
  ...
  export type UserPasswordRelationFilter = {
