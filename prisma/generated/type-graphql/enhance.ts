...
const relationResolversInfo = {
  ...
  Profile: ["user", "exams", "group"],
  Grade: ["groups"],
  Group: ["profiles", "grade"],
  Exam: ["Profile"]
};
...
const modelsInfo = {
  ...
  Exam: ["id", "createdAt", "updatedAt", "score", "note", "profileId"]
};
...
const outputsInfo = {
  ...
  ExamGroupBy: ["id", "createdAt", "updatedAt", "score", "note", "profileId", "_count", "_avg", "_sum", "_min", "_max"],
  ...
  ExamCountAggregate: ["id", "createdAt", "updatedAt", "score", "note", "profileId", "_all"],
  ExamAvgAggregate: ["score"],
  ExamSumAggregate: ["score"],
  ExamMinAggregate: ["id", "createdAt", "updatedAt", "score", "note", "profileId"],
  ExamMaxAggregate: ["id", "createdAt", "updatedAt", "score", "note", "profileId"]
};
...
const inputsInfo = {
  ...
  ProfileWhereInput: ["AND", "OR", "NOT", "id", "bio", "createdAt", "updatedAt", "user", "exams", "groupId", "group"],
  ProfileOrderByWithRelationInput: ["id", "bio", "createdAt", "updatedAt", "user", "exams", "groupId", "group"],
  ...
  GroupWhereInput: ["AND", "OR", "NOT", "id", "name", "createdAt", "updatedAt", "startAt", "endAt", "profiles", "gradeId", "grade"],
  GroupOrderByWithRelationInput: ["id", "name", "createdAt", "updatedAt", "startAt", "endAt", "profiles", "gradeId", "grade"],
  ...
  ExamWhereInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "score", "note", "profileId", "Profile"],
  ExamOrderByWithRelationInput: ["id", "createdAt", "updatedAt", "score", "note", "profileId", "Profile"],
  ExamWhereUniqueInput: ["id"],
  ExamOrderByWithAggregationInput: ["id", "createdAt", "updatedAt", "score", "note", "profileId", "_count", "_avg", "_max", "_min", "_sum"],
  ExamScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "score", "note", "profileId"],
  ...
  ProfileCreateInput: ["bio", "createdAt", "updatedAt", "user", "exams", "group"],
  ProfileUpdateInput: ["bio", "createdAt", "updatedAt", "user", "exams", "group"],
  ...
  GroupCreateInput: ["id", "name", "createdAt", "updatedAt", "startAt", "endAt", "profiles", "grade"],
  GroupUpdateInput: ["id", "name", "createdAt", "updatedAt", "startAt", "endAt", "profiles", "grade"],
  ...
  ExamCreateInput: ["id", "createdAt", "updatedAt", "score", "note", "Profile"],
  ExamUpdateInput: ["id", "createdAt", "updatedAt", "score", "note", "Profile"],
  ExamCreateManyInput: ["id", "createdAt", "updatedAt", "score", "note", "profileId"],
  ExamUpdateManyMutationInput: ["id", "createdAt", "updatedAt", "score", "note"],
  ...
  ExamCountOrderByAggregateInput: ["id", "createdAt", "updatedAt", "score", "note", "profileId"],
  ExamAvgOrderByAggregateInput: ["score"],
  ExamMaxOrderByAggregateInput: ["id", "createdAt", "updatedAt", "score", "note", "profileId"],
  ExamMinOrderByAggregateInput: ["id", "createdAt", "updatedAt", "score", "note", "profileId"],
  ...
  ProfileCreateWithoutUserInput: ["bio", "createdAt", "updatedAt", "exams", "group"],
  ...
  ProfileUpdateWithoutUserInput: ["bio", "createdAt", "updatedAt", "exams", "group"],
  ...
  ExamCreateWithoutProfileInput: ["id", "createdAt", "updatedAt", "score", "note"],
  ExamCreateOrConnectWithoutProfileInput: ["where", "create"],
  ExamCreateManyProfileInputEnvelope: ["data", "skipDuplicates"],
  GroupCreateWithoutProfilesInput: ["id", "name", "createdAt", "updatedAt", "startAt", "endAt", "grade"],
  ...
  ExamScalarWhereInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "score", "note", "profileId"],
  GroupUpsertWithoutProfilesInput: ["update", "create"],
  GroupUpdateWithoutProfilesInput: ["id", "name", "createdAt", "updatedAt", "startAt", "endAt", "grade"],
  GroupCreateWithoutGradeInput: ["id", "name", "createdAt", "updatedAt", "startAt", "endAt", "profiles"],
  ...
  ProfileCreateWithoutGroupInput: ["bio", "createdAt", "updatedAt", "user", "exams"],
  ...
  ProfileCreateWithoutExamsInput: ["bio", "createdAt", "updatedAt", "user", "group"],
  ProfileCreateOrConnectWithoutExamsInput: ["where", "create"],
  ProfileUpsertWithoutExamsInput: ["update", "create"],
  ProfileUpdateWithoutExamsInput: ["bio", "createdAt", "updatedAt", "user", "group"],
  ...
  ExamCreateManyProfileInput: ["id", "createdAt", "updatedAt", "score", "note"],
  ExamUpdateWithoutProfileInput: ["id", "createdAt", "updatedAt", "score", "note"],
  GroupCreateManyGradeInput: ["id", "name", "createdAt", "updatedAt", "startAt", "endAt"],
  GroupUpdateWithoutGradeInput: ["id", "name", "createdAt", "updatedAt", "startAt", "endAt", "profiles"],
  ProfileCreateManyGroupInput: ["id", "bio", "createdAt", "updatedAt"],
  ProfileUpdateWithoutGroupInput: ["bio", "createdAt", "updatedAt", "user", "exams"]
};
